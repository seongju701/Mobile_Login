...
public class M_014 {
	 ...
	 * Subject : CJ Mall 운영  
	 * Name : M_014
	 * Scenario :  로그인 > 회원가입 > 통합 회원가입 선택 (CJmall X CJ ONE)
	...
	@Test
	public void m_014() throws Exception {
		...
		System.out.println("통합회원가입");
		//회원가입
		Thread.sleep(7000);
		
		
		System.out.println(driver.findElement(By.xpath("//*[@id='registerCjOne']")).getText());
		// text check
