...
public class M_018 {
	 ...
	 * Subject : CJ Mall 운영  
	 * Name : M_018
	 * Scenario :  임직원 ID 로그인 하기
	 * Assertion :  Mobile : ***(이름) Text 체크
	 *   
	 */
	...
	@Test
	public void m_018() throws Exception {
		...
		// text check
        if ("성*정".equals(driver.findElement(By.xpath("//*[@id='gnb']/div[1]/p/strong")).getText())) {
