...
public class M_011 {
	 ...
	 * Subject : CJ Mall 운영  
	 * Name : M_011
	 * Scenario :  로그인 > 비밀번호 찾기 > 아이디 입력 > 조회 버튼 선택
	 * Assertion :  '고객님의 아이디 *** 확인되었습니다. Text 체크
	 *   
	 */
	...
	@Test
	public void m_011() throws Exception {
		...
		System.out.println((driver.findElement(By.xpath("//*[@id='txt_notice']")).getText()));
