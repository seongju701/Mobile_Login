...
public class M_077 {
	...
	@Test
	public void m_077() throws Exception {
		...
		System.out.println(driver.findElement(By.xpath("//*[@id=\"_imageFlicking\"]/ul/li[1]/div/div/img")).getTagName());
		// text check
		if ("img".equals(driver.findElement(By.xpath("//*[@id=\"_imageFlicking\"]/ul/li[1]/div/div/img")).getTagName())) {
