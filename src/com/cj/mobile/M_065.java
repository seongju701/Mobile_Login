...
public class M_065 {
	...
	@Test
	public void m_065() throws Exception {
		...
		if ("간편회원가입".equals(driver.findElement(By.xpath("//*[@id=\"header\"]/div/h1")).getText())) {
			Thread.sleep(3000);
			System.out.println("TC_65 PASS");
			assertTrue(true);
			return;
		} else {
			System.out.println("TC_65 FAIL");
			assertTrue(false);
		}
