...
public class M_073 {
	...
	@Test
	public void m_073() throws Exception {
		...
		if ("회원등급 패밀리".equals(driver.findElement(By.xpath("//*[@id=\"gnb\"]/div[1]/p/a/i/span")).getText())) {
			Thread.sleep(3000);
			System.out.println("TC_73 PASS");
			assertTrue(true);
			return;
		} else {
			System.out.println("TC_73 FAIL");
			assertTrue(false);
		}
