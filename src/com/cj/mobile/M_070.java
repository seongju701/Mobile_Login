...
public class M_070 {
	...
	@Test
	public void m_070() throws Exception {
		...
		if ("회원등급 플래티넘".equals(driver.findElement(By.xpath("//*[@id=\"gnb\"]/div[1]/p/a/i/span")).getText())) {
			Thread.sleep(3000);
			System.out.println("TC_70 PASS");
			assertTrue(true);
			return;
		} else {
			System.out.println("TC_70 FAIL");
			assertTrue(false);
		}
