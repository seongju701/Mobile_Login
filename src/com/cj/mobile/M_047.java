...
public class M_047 {
	...
	@Test
	public void m_047() throws Exception {
		...
		Thread.sleep(3000);
		//문의내역 클릭
		driver.findElement(By.xpath("//*[@id='content']/div/div[1]/ul/li[2]/a")).click();
		Thread.sleep(7000);
		
		
		if ("1:1 문의내역".equals(driver.findElement(By.xpath("//*[@id='header']/div/h1")).getText())) {
			Thread.sleep(3000);
			System.out.println("TC_47 PASS");
			assertTrue(true);
			return;
		} else {
			System.out.println("TC_47 FAIL");
			assertTrue(false);
		}
