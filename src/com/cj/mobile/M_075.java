...
public class M_075 {
	...
	@Test
	public void m_075() throws Exception {
		...
		WebElement searchBtn = driver.findElement(By.xpath("//*[@id=\"footer\"]/div[1]/div[2]/address"));
		Actions action = new Actions(driver);
		action.moveToElement(searchBtn).perform();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id=\"footer\"]/div[1]/div[1]/ul/li[2]/a")).click();
		System.out.println("로그아웃 성공");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id=\"header\"]/div[2]/a[1]/span")).click();
		System.out.println("좌측 메뉴 클릭");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id=\"gnb\"]/div[1]/a/span")).click();
