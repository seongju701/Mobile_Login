...
public class M_026 {
	 ...
	 * Subject : CJ Mall 운영  
	 * Name : M_026
	 * Scenario :  임의의 상품 > 쇼핑찜 선택 > 알럿 닫기 선택 > ID / PW 입력 > 로그인 
	 * Assertion :  찜 Text 체크
	 *   
	 */
	...
	@Test
	public void m_026() throws Exception {
		...
		if ("찜".equals(
				driver.findElement(By.xpath("//*[@id='content']/div[1]/div[1]/div[2]/div[1]/ul/li[1]/a")).getText())) {
